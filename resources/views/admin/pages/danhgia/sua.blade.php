...
@section('content')
    ...
    <div class="table-agile-info">
        ...
        <div class="table-responsive">
            ...
            <div>
                <div class="form">
                    <form class="cmxform form-horizontal" action="admin/danhgia/sua/{{ $danhgia->id }}" id="commentForm"
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-lg-9">
                                <textarea name="noidung" class="form-control" cols="30" rows="10"
                                    placeholder="Vui Lòng Nhập Câu Trả Lời Của Bạn">{{ $traloi->noidung }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
