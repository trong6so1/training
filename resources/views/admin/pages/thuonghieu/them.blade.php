...
@section('content')
    ...
    <div class="panel-body">
        <div class=" form">
            <form class="cmxform form-horizontal " id="commentForm" method="POST" action="admin/thuonghieu/them"
                ...
                <div class="form-group ">
                    ...
                    <div class="col-lg-6">
                        <textarea rows="5" class="form-control ckeditor" id="ccomment" name="MoTa"></textarea>
                    </div>
                </div>
                <div class="form-group ">
                    <label for="ccomment" class="control-label col-lg-3">Hiển Thị:</label>
                    <div class="col-lg-6">
                        <input type="radio" name="Hien" id="" value="1">Hiện
                        <input type="radio" name="Hien" value="0">Ẩn
