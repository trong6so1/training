...
@section('content')
    ...
    <div class="panel-body">
        <div class=" form">
            <form class="cmxform form-horizontal " id="commentForm" method="POST" action="admin/sanpham/them"
                novalidate="novalidate" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <div class="form-group ">
                    <label for="cname" class="control-label col-lg-3">Tên Sản Phẩm</label>
                    <div class="col-lg-6">
                        <input class=" form-control" id="cname" name="TenSanPham" type="text">
                    </div>
                </div>
                <div class="form-group ">
                    <label for="ccomment" class="control-label col-lg-3">Mô Tả Sản Phẩm</label>
                    <div class="col-lg-6">
                        <textarea rows="5" class="form-control ckeditor" id="ccomment" name="MoTa" required=""></textarea>
                    </div>
                </div>
                <div class="form-group ">
                    <label for="ccomment" class="control-label col-lg-3">Trạng Thái:</label>
                    <div class="col-lg-6">
                        <input type="radio" name="TrangThai" id="" value="1">Còn Hàng
                ...
                <div class="form-group ">
                    ...
                    <div class="col-lg-6">
                        <input class=" form-control" id="cname" name="Gia" type="number" min="1000">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <select name="idDanhMuc" class="form-control">
                            @foreach ($danhmuc as $dm)
                                <option @if ($dm->id === 0) elected @endif value="{{ $dm->id }}">
