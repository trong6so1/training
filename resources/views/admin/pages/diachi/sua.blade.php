...
@section('content')
    ...
    <div class="panel-body">
        <div class=" form">
            <form class="cmxform form-horizontal " id="commentForm" method="POST" action="admin/diachi/sua/{{ $diachi->id }}"
                novalidate="novalidate" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <div class="form-group ">
                    <label for="cname" class="control-label col-lg-3">Tên Phường:</label>
                    <div class="col-lg-6">
                        <input class="form-control" id="cname" value="{{ $diachi->tenphuong }}" name="tenphuong"
                            type="text">
                    </div>
                </div>
                <div class="form-group ">
                    ...
                    <div class="col-lg-6">
                        <input class="form-control" id="cname" name="gia" type="number" value="{{ $diachi->gia }}"
                            min="0">
                    </div>
                </div>
                <div class="form-group">
