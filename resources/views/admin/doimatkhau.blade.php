...
<body>
    <div class="log-w3">
        <div class="w3layouts-main">
            ...
            @endif
            <form action="admin/doimatkhau/{{ $id }}" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <input type="password" class="ggg" name="matkhaucu" placeholder="Nhập Mật Khẩu Cũ">
                <input type="password" class="ggg" name="matkhaumoi" placeholder="Nhập Mật Khẩu Mới">
                <input type="password" class="ggg" name="nhaplaimatkhau" placeholder="Nhập Lại Mật Khẩu Mới">
