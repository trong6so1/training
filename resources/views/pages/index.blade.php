        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-9 padding-right">
                    ...
                    @if (count($giamgia) > 0)
                    <!--features_items-->
                        <a href="hiensanphamgiamgia" class="xemtatcasanphamgiamgia">
                            <h2 class="title text-center">Xem Tất Cả</h2>
                        </a>
                    @endif
                    ...
                    @if (count($sanphambannhieu) > 0)
                        <div class="features_items">
                            <!--features_items-->
                            <h2 class="title text-center">Sản Phẩm Bán Chạy Nhất</h2>
                            @foreach ($sanphambannhieu as $sp)
                                <div class="col-sm-4">
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <a href="chitietsanpham/{{ $sp->id }}">
        ...
        $(document).ready(function() {
            ...
            setInterval(() => {
                $.get("sanphamgiamgia",
                    function(data) {
                        if (data.length > 0) {
                            if ($("#titlegiamgia").html() != null) {
                                $(".giamgiasanpham").remove();
                                themsanphamgiamgia(data);
                            } else {
                                $html =
                                    "<h2 class='title text-center' id='titlegiamgia'>Sản Phẩm Giảm Giá</h2>"
                                $("#sanphamgiamgia").append($html);
                                $html =
                                    "<a href='hiensanphamgiamgia' class='xemtatcasanphamgiamgia'><h2 class='title text-center'>Xem Tất Cả</h2></a>"
                                $("#titlegiamgia").after($html);
                                themsanphamgiamgia(data);
